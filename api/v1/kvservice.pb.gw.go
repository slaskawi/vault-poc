...
func RegisterKVServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server KVServiceServer) error {
	...
	mux.Handle("GET", pattern_KVService_SystemRotate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kvservice.v1.KVService/SystemRotate", runtime.WithHTTPPathPattern("/v1/system/rotate"))
		if err != nil {
	...
	mux.Handle("GET", pattern_KVService_SystemStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/kvservice.v1.KVService/SystemStatus", runtime.WithHTTPPathPattern("/v1/system/status"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
func RegisterKVServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client KVServiceClient) error {
	...
	mux.Handle("GET", pattern_KVService_SystemRotate_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kvservice.v1.KVService/SystemRotate", runtime.WithHTTPPathPattern("/v1/system/rotate"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
	...
	mux.Handle("GET", pattern_KVService_SystemStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateContext(ctx, mux, req, "/kvservice.v1.KVService/SystemStatus", runtime.WithHTTPPathPattern("/v1/system/status"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
